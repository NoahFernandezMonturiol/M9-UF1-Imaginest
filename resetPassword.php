			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="index.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input required class="input100" type="text" name="UserOrMail" placeholder="Password">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input required class="input100" type="password" name="pass" placeholder="Repeat password">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
